...
function check(){
	var check_ = '<div class="container xlarge"><table class="bordered">' + 
		...
		'<tr><td><input id="repair_material_name" type="text" /></td><td><input type="button" value="确定" onclick="select_by_name()"/></td></tr>'+
		'</table></div>';
...
function check_insert(repair_material_id){
	var insert_html = '<div class="container xlarge"><table class="bordered">' + 
		...
		'</a></td><td><input id="repair_project_name" type="text" /></td><td><input id="repair_material_cost_amount" type="number" /></td><td><input type="button" onclick="insert()" value="确定"/></td></tr>'+
		'</table></div>';
